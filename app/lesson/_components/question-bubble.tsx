...
export const QuestionBubble = ({ question } : QuestionBubbleProps) => {
    return (
        <div className='flex items-center gap-x-4 mb-6'>
            <Image src={'/vocavue_pictorial_logo.svg'} alt='Voca' height={60} width={60} className='hidden lg:block'/>
            <Image src={'/vocavue_pictorial_logo.svg'} alt='Voca' height={40} width={40} className='block lg:hidden'/>
